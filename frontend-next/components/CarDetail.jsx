  ...
  return (
    <div className="cd-overlay" onClick={onClose}>
      <div className="cd" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="cd-img">🚗</div>
        <div className="cd-body">
          <div className="cd-model">{sel.label}{row ? ` · ${row.제조사}` : ""}</div>
          ...
          {row && (
            <>
              ...
              <div className="cd-actions">
                ...
                <a className="cd-link" href={carLink(row.제조사, row.모델명)} target="_blank" rel="noreferrer">차량 정보 보기 →</a>
              </div>
            </>
          )}
        </div>
