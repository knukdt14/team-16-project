...
// 값은 data/ev_subsidy_data_sigungu.csv 실측 기준 (2026)
//  · 최대 보조금 1,872만원 = 전체 최댓값(경북 울릉군, Pv5 WAV)
//  · 지원 차종 121종 = 고유 모델명 수 / 시·군·구 160곳 = 고유 (시도,시군구) 수
const STATS = [
  { to: 1872, suf: "만원", k: "최대 보조금" },
  { to: 121, suf: "종", k: "지원 차종" },
  { to: 160, suf: "곳", k: "시·군·구" },
];
