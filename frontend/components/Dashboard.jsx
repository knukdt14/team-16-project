...
export default function Dashboard() {
  ...
  const [selectedModel, setSelectedModel] = useState("EV6");
    ...
    <div className="app">
      ...
      <div className="grid">
          ...
          {tab === "map" && (
            <motion.div className="card" initial={{ opacity: 0, y: 12 }}
              ...
              <div className="map-stage">
                <KoreaMap mode={mapMode} highlightRegion={highlightRegion} selectedModel={selectedModel} />
              </div>
            </motion.div>
          )}
          {tab === "region" && <RegionCompare initialModel={selectedModel} />}
        ...
        <Chatbot
          ...
          mapMode={mapMode}
          onSelectRegion={(r) => { setHighlightRegion(r); setTab("map"); }}
          onSelectModel={(m) => { if (m) setSelectedModel(m); }}
        />
      </div>
